...
namespace StateswitchStcHardOCP {
...
struct StateswitchStcHardExtra {
...
inline OCPDescriptor descriptor() {
    ...
    d.create = [](const OCPCreateArgs& a) {
        ...
        if (a.extra.has_value()) {
            try {
                ex = std::any_cast<StateswitchStcHardExtra>(a.extra);
