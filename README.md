...
**CoManDO (Convergent Maneuvering for Autonomous Drone Operations)** is a high-performance, platform-agnostic MPC planner designed for complex maneuvering and dynamic target tracking. It utilizes the **ALIPDDP** (Augmented Lagrangian Iterative Pontryagin Differential Dynamic Programming) solver to execute real-time optimal control.
