...
| `stc_z_stage`, `stc_los_alt_trig` | `1.4` / `1.2` | stc_landing staging floor / LOS trigger altitude (target-relative metres). Floor 1.4 assumes a true world-1.8 engagement hover (profile commands 2.05); from a lower ~1.54 settle use `stc_z_stage:=1.3` |
