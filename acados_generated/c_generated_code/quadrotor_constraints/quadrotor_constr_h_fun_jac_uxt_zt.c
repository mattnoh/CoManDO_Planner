...
static const casadi_int casadi_s4[15] = {19, 3, 0, 3, 6, 9, 0, 1, 2, 6, 7, 8, 0, 1, 2};
static const casadi_int casadi_s5[3] = {3, 0, 0};

/* quadrotor_constr_h_fun_jac_uxt_zt:(i0[13],i1[6],i2[],i3[])->(o0[3],o1[19x3,9nz],o2[3x0]) */
